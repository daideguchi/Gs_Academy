...
(function ($) {
  ...
  $.cleditor = {
    ...
    defaultOptions: {
      ...
      bodyStyle: "margin:11px; font:12pt Arial,Verdana; cursor:text",
    },
  ...
  function createPopup(
    ...
    // URL
      ...
      $popup.html(
        '<label>Enter URL:<br /><input type="text" value="http://" style="width:200px" /></label><br /><input type="button" value="Submit" />'
      );
    ...
    // Paste as Text
      ...
      $popup.html(
        '<label>Paste your content here:<br /><textarea rows="3" style="width:200px"></textarea></label><br /><input type="button" value="Submit" />'
      );
      popupTypeClass = PROMPT_CLASS;
    }
  ...
  function execCommand(editor, command, value, useCSS, button) {
    ...
    if (ie && inserthtml) getRange(editor).pasteHTML(value);
  ...
  function refresh(editor) {
    ...
    if (ie || iege11) {
      ...
      $doc.bind(
        "beforedeactivate beforeactivate selectionchange keypress keyup",
        function (e) {
    ...
    $(function () {
      ...
      // Resize the toolbar
      var hgt =
        $group.offset().top + $group.outerHeight() - $toolbar.offset().top + 1;
      $toolbar.height(hgt);
